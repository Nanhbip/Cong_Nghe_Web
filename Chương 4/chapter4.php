...
// TODO 2: Kiểm tra form POST và có 'ten_sinh_vien'
if (isset($_POST['ten_sinh_vien']) && isset($_POST['email'])) {
    ...
    $stmt->execute([$ten, $email]);
        ...
        // TODO 6: Chuyển hướng để tránh submit lại khi reload
